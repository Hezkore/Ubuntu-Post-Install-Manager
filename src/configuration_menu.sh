...
function config_gnome_shortcuts () {
	...
	dconf write /org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom5/command "'quake3 +map q3dm17 +addbot random 5 0 6000 Linus +fraglimit 10 +timelimit 5'"
